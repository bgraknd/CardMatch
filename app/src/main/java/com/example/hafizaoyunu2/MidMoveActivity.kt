...
import kotlinx.android.synthetic.main.activity_mid_move.*
import java.util.*

class MidMoveActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mid_move)
    ...
    override fun onClick(v: View?) {
        ...
        sayacTimer++
        sayacSonuc = 50-(sayacTimer/2)
        Log.e("LOGCAT","Sayac: $sayacTimer")
        txtMove.text = "Kalan Hamle Sayisi: $sayacSonuc"
        if (sayacSonuc == 0){
            val intent = Intent(this@MidMoveActivity, LoseActivity::class.java)
